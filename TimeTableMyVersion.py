...
for p in range(k):
    ...
    my_pdf.cell(200, 10, txt="----------TIME TABLE---------", ln=1, align="C")
    print(p+1,end="")
    print("------------")
    print("TIME\tMONDAY\tTUESDAY\tWEDNESDAY\tTHURSDAY\tFRIDAY")
    my_pdf.cell(200, 10, txt="TIME\tMONDAY\tTUESDAY\tWEDNESDAY\tTHURSDAY\tFRIDAY", ln=1, align="C")
    for i in range(R):
        #1my_pdf.cell(time[i])
